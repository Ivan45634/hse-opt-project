...
from problems_cv import cifar_prepocess
...
def main(args, parser):
    args.results_path = f"./src/cv/{args.results_path}"
    args.tune_path = f"./src/cv/{args.tune_path}"
    ...
    if args.tune or args.use_old_tune_params:
        if not args.use_old_tune_params:
            print("~~~~~~~~~~~~~~~ TUNING ~~~~~~~~~~~~~~~")
